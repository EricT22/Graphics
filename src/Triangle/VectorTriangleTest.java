...
public class VectorTriangleTest {
	...
	public static void main(String[] args) {
		...
		v0 = new Vector(0.0, 0.0, 10.0, null);
		v1 = new Vector(10.0, 0.0, 10.0, null);
		v2 = new Vector(0.0, 10.0, 10.0, null);
		printData(v0, v1, v2);
		v0 = new Vector(10.0, 10.0, 10.0, null);
		v1 = new Vector(0.0, 10.0, 10.0, null);
		v2 = new Vector(10.0, 0.0, 10.0, null);
		printData(v0, v1, v2);
		v0 = new Vector(10.0, 0.0, 10.0, null);
		v1 = new Vector(10.0, 0.0, 0.0, null);
		v2 = new Vector(10.0, 10.0, 10.0, null);
		printData(v0, v1, v2);
		v0 = new Vector(10.0, 10.0, 0.0, null);
		v1 = new Vector(10.0, 10.0, 10.0, null);
		v2 = new Vector(10.0, 0.0, 0.0, null);
		printData(v0, v1, v2);
		v0 = new Vector(10.0, 0.0, 0.0, null);
		v1 = new Vector(0.0, 0.0, 0.0, null);
		v2 = new Vector(10.0, 10.0, 0.0, null);
		printData(v0, v1, v2);
		v0 = new Vector(0.0, 10.0, 0.0, null);
		v1 = new Vector(10.0, 10.0, 0.0, null);
		v2 = new Vector(0.0, 0.0, 0.0, null);
		printData(v0, v1, v2);
		v0 = new Vector(0.0, 0.0, 0.0, null);
		v1 = new Vector(0.0, 0.0, 10.0, null);
		v2 = new Vector(0.0, 10.0, 0.0, null);
		printData(v0, v1, v2);
		v0 = new Vector(0.0, 10.0, 10.0, null);
		v1 = new Vector(0.0, 10.0, 0.0, null);
		v2 = new Vector(0.0, 0.0, 10.0, null);
		printData(v0, v1, v2);
		v0 = new Vector(0.0, 10.0, 10.0, null);
		v1 = new Vector(10.0, 10.0, 10.0, null);
		v2 = new Vector(0.0, 10.0, 0.0, null);
